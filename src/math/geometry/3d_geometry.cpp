...
Point ClosestPoint(const Triangle& triangle, const Point& point)
{
    ...
    Point c1 = ClosestPoint(Line(triangle.a, triangle.b), point); // Line AB
    Point c2 = ClosestPoint(Line(triangle.b, triangle.c), point); // Line AB
    Point c3 = ClosestPoint(Line(triangle.c, triangle.a), point); // Line AB

    float magSqr1 = MagnitudeSqr(point - c1);
    float magSqr2 = MagnitudeSqr(point - c2);
    float magSqr3 = MagnitudeSqr(point - c3);
